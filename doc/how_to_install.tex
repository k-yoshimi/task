...
\item
  ...
  \begin{itemize}
  \item
    \ttype{sudo port install fftw scalapack superlu mumps hdf5}
  \end{itemize}
\end{itemize}
...
\title{Preparation for macOS (4)}
\begin{itemize}
\item
  \emA{Install PETSC} (PETCS in macports doesn't work at present)
  \begin{itemize}
  \item
    \emB{Add to .zprofile}
    \begin{itemize}
      \item
        \ttype{export PATH=/opt/local/bin:\$PATH}
      \item
    ...
    \end{itemize}
   \item
     \emB{Setup to use python and mpi}
     \begin{itemize}
     \item
       \ttype{sudo port select python python311}
     \item
       \ttype{sudo port select mpi mpich-mp-fortran}
     \end{itemize}
   \item
     ...
     \item
       \ttype{cd /opt/PETSc}
     \item
       \ttype{git clone -b release https://gitlab.com/petsc/petsc.git petsc}
     \item
       \ttype{cd petsc}
     \item
       \ttype{cp ~/git/task/doc/default.py .}
     \item
...
\dummy{
\title{Preparation for macOS (5)}
\begin{itemize}
\item
  \emA{In case of macOS major version-up}: e.g. 14.3 \s 15.0
\item
