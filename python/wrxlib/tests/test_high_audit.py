...
from wrxlib.errors import WrxlibParamError, WrxlibStateError  # noqa: E402
...
class FakeWrxLib:
    ...
    def wrx_set_param(self, name, value) -> int:
        return 0
